...
export type Statement =
  ...
  | SwitchStatement
  | ThrowStatement
  | TryStatement                        // Todo, Relies on pattern
  | VariableDeclaration
  | WhileStatement
  | WithStatement
  | ClassDeclaration
  | ExportAllDeclaration                // Todo, relies on literal
  | ExportDefaultDeclaration            // Todo, Relies on decl
  | ExportNamedDeclaration              // Todo, Relies on decl
  | ForOfStatement
  | ImportDeclaration                   // Todo, Relies on specifiers.
  | FlowDeclareClass                    
  | FlowDeclareFunction
...
export type ForLike = ForStatement | ForInOf; // Concept.
